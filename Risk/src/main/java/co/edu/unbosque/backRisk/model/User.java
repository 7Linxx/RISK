 ...
 * <p>
 * Mapeada a la tabla "users", contiene los datos básicos de un usuario como
 * identificador, nombre de usuario, nombre completo, correo, contraseña y fecha
 * de nacimiento.
 * </p>
 * 
...
public class User {
	...
	/**
	 * Calcula el código hash del objeto basado en sus campos relevantes.
	 * 
	 * @return código hash
	 */
	@Override
